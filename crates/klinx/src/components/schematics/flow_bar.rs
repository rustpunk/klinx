            ...
            for (i, stage) in stages.iter().enumerate() {
                ...
                // Stage pill
                {
                    ...
                    rsx! {
                        div {
                            key: "flow-{stage.id}",
                            class: "klinx-flow-pill",
                            "data-stage-kind": kind_attr,
                            style: "border-top-color: var(--klinx-stage-accent); \
                                    background: color-mix(in srgb, var(--klinx-stage-accent) 8%, var(--klinx-char-surface)); \
                                    border-color: color-mix(in srgb, var(--klinx-stage-accent) 20%, var(--klinx-border-subtle));",

                            span {
                                class: "klinx-flow-pill-label",
                                "{stage.label}"
                            }
                            span {
                                class: "klinx-flow-pill-badge",
